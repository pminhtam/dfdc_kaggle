...
checkpoints = keras.callbacks.ModelCheckpoint("./siamese/checkpoint_{epoch:04d}.pth", monitor='val_loss', verbose=0, save_best_only=False, period=1)

model.fit_generator(generator_train,validation_data=generator_val,epochs=50,workers=8,callbacks = [tensorboard_callback,checkpoints],initial_epoch = 14)