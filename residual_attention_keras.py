...
IMAGE_SHAPE = 256
model = AttentionResNetCifar10(shape=(IMAGE_SHAPE, IMAGE_SHAPE, 3),n_channels=32, n_classes=1)
...
model.fit_generator(generator,validation_data=test_generator, steps_per_epoch=int(1142792/batch_size), epochs=30,workers=4,validation_steps=14298/batch_size,class_weight = class_weights,callbacks = callbacks)
