...
#         text_writer = open(os.path.join(opt.outf, 'train.csv'), 'w')
    ...
    dataloader_train = torch.utils.data.DataLoader(dataset_train, batch_size=opt.batchSize,sampler = sampler, num_workers=int(opt.workers))
